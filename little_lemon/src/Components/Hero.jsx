        ...
        <div style={{ display: 'flex', backgroundColor: '#F4CE14' }}>
            {isNotMobile ? (
                <>
                    ...
                    <div style={{ marginTop: '3%', marginRight: '3%', marginBottom: '2%', flex: '2', overflow: 'hidden', backgroundColor: '#F4CE14' }}>
                        <img
                ...
                <div style={{ display: 'flex', flexDirection: 'column', backgroundColor: '#F4CE14' }}>
                    ...
                    <div style={{ flex: '2', backgroundColor: '#F4CE14', alignSelf: 'center', marginLeft: '3%', overflow: 'hidden', objectFit: 'cover' }}>
                        <img
                            src={images[currentIndex]}
                            alt={`slide-${currentIndex + 1}`}
                            style={{
